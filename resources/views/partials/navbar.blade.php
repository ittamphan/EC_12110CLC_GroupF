<div class="headertop_desc">
			...
			<div class="account_desc">
				...
				@else
					...
					@else
						...
						<li><a href="{{ route('show.profile', Auth::user()->id ) }}">Profile</a></li>
						<li><a href="{{ url('/logout') }}">Logout!</a></li>
					@endif	
				@endif
				</ul>
		...
		<div class="header_top">
			...
			@if(Auth::check())
			  <div class="cart">
			  	   <p>Home Shoppe
			  	   <span>Cart:</span><div id="dd" class="wrapper-dropdown-2"><a href="{{ route('mycart') }}">{!! count($number_of_items) !!} item(s) - $0.00</a>
			  	   	<ul class="dropdown">
							<li>You have {!! count($number_of_items) !!} items in your Shopping cart</li>
					</ul></div></p>
			  </div>
			  @endif
