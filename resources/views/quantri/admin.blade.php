      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="{{ route('show.profile', Auth::user()->id) }}"><img src="{{ asset('public/assets-admin/img/' .Auth::user()->profile_pic) }}" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li>
                          <a href="{{ route('admin.orderManagement') }}">
                            <i class="fa fa-gear"></i>
                              <span>Manage</span>
                          </a>
                          </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li>
                          <a href="{{ route('admin.orderdetailShow') }}">
                            <i class="fa fa-gear"></i>
                              <span>Show</span>
                          </a>
                          </li>
                    ...
                    <!-- USERS ONLINE SECTION -->
                      ...
                      <div class="desc">
                        ...
                        @if($user->profile_pic == null)
                          <img class="img-circle" src="{{ asset('public/assets-admin/img/no-image.png') }}" width="35px" height="35px" align="">
                        @else
